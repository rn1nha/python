...
SELECT
last_name, 12 * salary * commission_pct, salary, commission_pct
FROM
employees;
...
SELECT
MONTHS_BETWEEN('22-12-16', '21-12-16')
FROM
dual;
SELECT
ADD_MONTHS('22-12-16', 1)
FROM
dual;
SELECT
NEXT_DAY('22-12-16', 1)
...
* /
SELECT
last_name, TO_CHAR(hire_date, 'YYYY/MM/DD HH24:MI:SS')
AS
HIREDATE
FROM
employees;
